...
compareaid<- rename(.data=compareaid, Country_a=Country.x, aid_given=count.x, Country_ha=Country.y, health_aid=count.y)
compareaid
#figure out how to get rid of the first country column
```
